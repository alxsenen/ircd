...
module.exports = {
	...
	https: {
		enable: true,
		key: "/opt/ircd/webchat/letsencrypt/letsencrypt/live/webchat.segured.org/privkey.pem",
		certificate: "/opt/ircd/webchat/letsencrypt/letsencrypt/live/webchat.segured.org/cert.pem",
		//ca: "",
	},
