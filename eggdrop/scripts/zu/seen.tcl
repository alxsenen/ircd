...
#*!*bates@YeRbA.users.undernet.org on Undernet.  Email: petermaik@gmail.com
...
#
#comandos:
#       pub:  !seen <pedido> [#canal]
#       msg:  seen <pedido> [#canal]
#     y dcc:  .seen <pedido> [#canal]
###

###Parameters:

#bs(limit) limite máximo de registro.  
set bs(limit) 40000
...
#bs(cmdchar) caracter que se usara por defecto en los pedidos via publica, por ejemplo: !seen nick, por defecto es " ! "
set bs(cmdchar) "!"
...
#bugfix: added a join on the $n  (c)
	...
	away {
	  set reason [lrange $data 5 e]
	    ...
	    set output [concat $n ($addy) se le vio poniendose en away ($reason) en $chan hace [bs_when $time] .]
	  }
	}
	chon { 
